...
Like survey standards and guidelines, evaluation criteria may need to be enhanced or updated to align with current survey practices, such as to address newly recognized heritage types. See [chapter 8](/part-2/chapter-8/) for more information on using evaluation criteria for surveys and [chapter 10](/part-2/chapter-10/) for more on making assessments of significance.
...
-   **The information technology systems manager** provides support for the data collection system used by the field surveyors. The IT systems manager may assist with developing, enhancing, and customizing data collection tools to meet the needs of the survey. The position may also assist with integrating heritage data from the inventory (and potentially other systems) into the survey data collection system, and vice versa. The position will be most effective if established during the early stages of the survey associated with developing data collection methods and standards. IT systems manager may be the role of personnel managing an existing inventory system; for example, the database administrator role discussed in [part I](/part-1/).
