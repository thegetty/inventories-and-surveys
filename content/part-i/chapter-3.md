...
The considerations are presented with the most fundamental first followed by others that build upon them. (Note that not all considerations will be relevant to every heritage organization.) A [Resources sidebar](#sidebar-1-resources) at the end of this chapter provides descriptions and directions to further guidance, related standards, or relevant examples of inventory practice.
...
-   What are the organization’s requirements and use cases for its inventory database?
...
{% accordion '## Resources' 'sidebar-1-resources' %}
